...
void Sculpt_manager::gen_fsck_ext2_start_content(Xml_generator &xml,
                                                 Storage_target const &target)
{
...
void Sculpt_manager::gen_mkfs_ext2_start_content(Xml_generator &xml,
                                                 Storage_target const &target)
{
	auto gen_args = [&] (Xml_generator &xml) {
		xml.node("arg", [&] () {
...
void Sculpt_manager::gen_resize2fs_start_content(Xml_generator &xml,
                                                 Storage_target const &target)
{
	auto gen_args = [&] (Xml_generator &xml) {
