...
void Sculpt_manager::Storage_dialog::generate(Xml_generator &xml) const
{
...
void Sculpt_manager::Storage_dialog::hover(Xml_node hover)
{
	bool const changed =
...
void Sculpt_manager::Storage_dialog::click(Action &action)
{
...
void Sculpt_manager::Storage_dialog::clack(Action &action)
{
	if (_confirm_item.hovered("confirm")) {
