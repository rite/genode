...
#ifndef _SRC__BOOTSTRAP__SPEC__APALIS_IMX6__BOARD_H_
#define _SRC__BOOTSTRAP__SPEC__APALIS_IMX6__BOARD_H_
...
#endif /* _SRC__BOOTSTRAP__SPEC__APALIS_IMX6__BOARD_H_ */
