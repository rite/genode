...
CC_MARCH := $(filter-out -mfloat-abi=softfp, $(CC_MARCH))
...
CXX_LINK_OPT    += -Wl,--dynamic-linker=/home/rite/x-tools/arm-linux-gnueabi/arm-linux-gnueabi/sysroot/lib/ld-linux.so.3
